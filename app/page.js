...
const Home = memo(({ hamburger }) => {
  ...
  return (
    <header
      ...
      } bg-gray-white h-[98px] flex flex-row py-[22px] px-20 box-border items-center justify-center sticky w-full top-[0] [background:white] z-[2] text-center text-5xl text-primary-500 font-body-large-400 lg:pl-10 lg:pr-10 lg:box-border md:pl-6 md:pr-6 md:box-border`}
    >
      <div className="flex-1 flex flex-row items-center justify-between">
        ...
        >
          ...
          <div className="flex flex-col items-start justify-start">
            <div className=" leading-[24px] font-semibold">PETS</div>
            <div className=" text-sm leading-[16px] font-medium">Blog App</div>
          </div>
        </Link>
        <div className="flex flex-row items-center justify-end gap-[36px] text-sm text-primary-900 md:flex sm:flex">
          <div className="flex flex-row items-start justify-start gap-[20px] md:hidden sm:hidden">
            ...
            <Link
              href="/"
              className=" leading-[22px] text-slategray no-underline"
            >
              HOME
            </Link>
            <Link
          ...
          <div className="hidden md:flex sm:flex xs:flex">
            <ThemeToggle />
          </div>
        ...
        <div className="text-gray-100 text-xl">
          <div className="p-2.5 mt-1 flex items-center rounded-md ">
            ...
            <button
              ...
              aria-controls="drawer-navigation"
              className="text-gray-200 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 absolute  right-2.5 inline-flex items-center justify-center dark:hover:bg-gray-600 dark:hover:text-white hover:cursor-pointer"
            >
              <svg
                class="w-3 h-3"
                aria-hidden="true"
          ...
          <div>
            <div className="relative flex items-center rounded-md bg-gray-200 dark:bg-gray-700  mt-3">
              <i className="bi bi-search text-gray-600 dark:text-gray-300 text-lg mr-2" />
              <input
                className="text-gray-600 dark:text-gray-300 w-full bg-transparent focus:outline-none placeholder-gray-400 border-0 focus:border-0 focus:ring-0"
                type="text"
                placeholder="Search..."
              />
            </div>
